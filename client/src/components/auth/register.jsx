...
export default function Register(props) {
    ...
    const registerUser = async () => {
        const userinfo = { email, password, first_name, last_name, profile_picture_link, phone, city, state, customer_id, address, zipcode, subscription_start, subscription_end }
